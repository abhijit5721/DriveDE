import { ArrowLeft, Mail, MapPin, Phone, Shield, FileText, Scale, Building2, AlertTriangle } from 'lucide-react';
...
export function LegalPage({ page, onBack }: LegalPageProps) {
  ...
  return (
    <div className="space-y-5 pb-6">
      <button
        onClick={onBack}
        className="inline-flex items-center gap-2 rounded-full px-3 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
      >
