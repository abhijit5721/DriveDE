...
export function Welcome() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-b from-blue-50/80 via-white to-white selection:bg-blue-500/30 text-slate-900">
      ...
      {/* Washed driving-photo backdrop — hero only, fades to white (Option 2 preview) */}
      <div className="pointer-events-none absolute inset-x-0 top-0 z-0 h-screen overflow-hidden" data-testid="hero-photo-backdrop">
        <img
      ...
      {/* 🚗 CTA photo banner — the driving shot, contained (Option 1 preview) */}
