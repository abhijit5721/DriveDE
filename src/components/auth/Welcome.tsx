            ...
            <div className="flex items-center gap-1 ml-2 border-l border-slate-700/50 pl-4">
              <button
                ...
                className={cn(
                  ...
                  language === 'de' ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/20' : 'text-slate-400 hover:text-white'
                )}
              >
                DE
              </button>
              <button
                ...
                className={cn(
                  'px-2 py-1 text-[10px] font-black rounded-lg transition-all',
                  language === 'en' ? 'bg-blue-500 text-white shadow-lg shadow-blue-500/20' : 'text-slate-400 hover:text-white'
                )}
              >
                EN
              </button>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={cn(
                      ...
                      language === 'de' ? 'bg-blue-500 text-white' : 'bg-slate-800 text-slate-400'
                    )}
                  >
                  ...
                  <button
                    ...
                    className={cn(
                      'px-4 py-2 text-xs font-black rounded-xl transition-all',
                      language === 'en' ? 'bg-blue-500 text-white' : 'bg-slate-800 text-slate-400'
                    )}
                  >
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-[10px] uppercase tracking-wider text-slate-400">{t.welcome.hero.happyStudents}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-bold text-white">94% {t.welcome.hero.passRate}</p>
                <p className="text-[10px] uppercase tracking-wider text-slate-400">{t.welcome.hero.firstAttempt}</p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              { 
                icon: Zap, 
                title: t.welcome.features.aiCoaching.title, 
                desc: t.welcome.features.aiCoaching.desc
              },
              { 
                icon: BadgeCheck, 
                title: t.welcome.features.maneuverReplay.title, 
                desc: t.welcome.features.maneuverReplay.desc
              },
              { 
                icon: Users, 
                title: t.welcome.features.instructorSync.title, 
                desc: t.welcome.features.instructorSync.desc
              }
            ].map((f, i) => (
        ...
        <div className="mx-auto max-w-4xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-slate-400">
              {t.common.startPersonalized}
            </p>
          </div>

          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2">
            {[
              { id: 'manual', title: t.welcome.paths.manual.title, desc: t.welcome.paths.manual.desc, icon: Cog, color: 'orange' },
              { id: 'automatic', title: t.welcome.paths.automatic.title, desc: t.welcome.paths.automatic.desc, icon: Zap, color: 'blue' },
              { id: 'umschreibung-manual', title: t.welcome.paths.umschreibungManual.title, desc: t.welcome.paths.umschreibungManual.desc, icon: BadgeCheck, color: 'purple' },
              { id: 'umschreibung-automatic', title: t.welcome.paths.umschreibungAutomatic.title, desc: t.welcome.paths.umschreibungAutomatic.desc, icon: BadgeCheck, color: 'emerald' },
            ].map((path) => (
              <button
                key={path.id}
      ...
      <footer className="relative z-10 border-t border-slate-800 bg-slate-900 px-6 py-12">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 md:flex-row">
          ...
          <p className="text-[10px] text-slate-600">
            © 2026 DriveDE AI. {t.common.allRightsReserved} {t.common.proDriverTech}
          </p>
        </div>
      </footer>
    </div>
