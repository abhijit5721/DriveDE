  ...
  de: {
    common: {
      ...
      publicTrainer: {
        ...
        savePrompt: 'Ergebnis speichern und weiterüben?',
        saveHint: 'Mit einem kostenlosen Konto merkt sich DriveDE deinen Fortschritt und schaltet die weiteren Trainer frei.',
        saveCta: 'Kostenlos weitermachen',
        oneMore: 'Noch eine Runde',
        close: 'Schließen',
        examQuestion: 'Wann ist deine praktische Prüfung?',
        examHint: 'Daraus wird dein Übungsplan. Du kannst das später ändern.',
        examNotBooked: 'Noch nicht gebucht',
        examContinue: 'Weiter',
        daysLeft: (n: number) => n === 0 ? 'Deine Prüfung ist heute.' : n === 1 ? 'Noch 1 Tag bis zur Prüfung.' : `Noch ${n} Tage bis zur Prüfung.`,
        examPast: 'Dieses Datum liegt schon hinter dir. Trag ein neues ein, wenn du den nächsten Termin hast.',
        planWithDate: (remaining: number, perWeek: number) => `${remaining} Trainer noch offen. Mit ${perWeek} pro Woche bist du vor dem Termin durch.`,
        planNoDate: (remaining: number) => `${remaining} Trainer noch offen. Jede Wiederholung der Prüfung kostet rund 600 Euro, also lohnt es sich, sie vorher zu kennen.`,
        keepPrompt: 'Plan und Countdown behalten?',
        keepHint: 'Mit einem kostenlosen Konto siehst du den Countdown jeden Tag und DriveDE merkt sich, was du schon kannst.',
        keepCta: 'Plan behalten',
        planTitle: 'Dein Plan bis zur Prüfung',
        shareCta: 'Ergebnis teilen',
        moreTrainers: 'Einparken und acht weitere Trainer gibt es in der App.',
        moreTrainersLink: 'Ansehen',
        resultTitle: 'Dein Ergebnis',
        resultScore: (correct: number, total: number) => `${correct} von ${total} richtig`,
        resultTime: (seconds: string) => `${seconds} Sekunden`,
        fasterThan: (pct: number) => `Schneller als ${pct} % aller Fahrschüler hier.`,
        flawless: 'Fehlerfrei. So sieht es der Prüfer gern.',
        yourMistake: 'Dein Fehler, erklärt',
        examConsequence: 'In der Prüfung beendet dieser Fehler die Fahrt und kostet rund 600 Euro.',
        moreMistakes: (n: number) => n === 1 ? 'Eine weitere Kreuzung lief auch nicht fehlerfrei.' : `${n} weitere Kreuzungen liefen auch nicht fehlerfrei.`,
        share: 'Teilen',
        shareHint: 'Als Bild für die Fahrschul-Gruppe.',
        shareDone: 'Bild gespeichert, Text kopiert. Einfach in WhatsApp einfügen.',
        ladder: {
          title: 'Drei Übungen',
          step: (n: number) => `Übung ${n}`,
          rung1: 'Rechts vor links',
          rung2: 'Kreisverkehr',
          rung3: 'Einparken',
          now: 'Jetzt dran',
          open: 'Offen',
          done: 'Geschafft',
          opensAfter: 'Nach Übung 1',
          locked: 'Mit kostenlosem Konto',
          nextRung: 'Weiter: Kreisverkehr',
          roundaboutDone: 'Kreisverkehr geschafft. Zwei von drei Übungen sind durch.',
          unlockPrompt: 'Einparken freischalten?',
          unlockHint: 'Die dritte Übung, Einparken mit Referenzpunkten, und acht weitere Trainer gibt es mit einem kostenlosen Konto.',
          unlockCta: 'Kostenlos freischalten',
      ...
      getStarted: 'Loslegen',
      proOnlyFeature: 'Nur für Pro-Nutzer verfügbar',
      cancel: 'Abbrechen',
      save: 'Speichern',
      pause: 'Pause',
      replay: 'Abspielen',
    ...
    welcome: {
      hero: {
        ...
        titlePrefix: 'Bestehe die Fahrprüfung',
        titleHighlight: 'beim ersten Versuch.',
        subtitle: 'Kostenlose 3D-Trainer für Vorfahrt, Einparken und Kreisverkehr, für Fahrschüler und Umschreiber.',
    ...
    account: {
      ...
      publicReportToggle: 'Bericht-Sichtbarkeit',
      publicReportToggleDesc: 'Erlaube deinem Fahrlehrer den Zugriff auf deinen Lernfortschritt via Link.',
      ...
      anonymousTitle: 'Konto nicht gesichert',
      anonymousDesc: 'Du nutzt DriveDE ohne E-Mail. Dein Fortschritt liegt nur in diesem Browser. Mit einer E-Mail kommst du auch auf dem Handy oder nach einem Browserwechsel wieder rein.',
      secureTitle: 'Konto sichern',
      secureEmailLabel: 'E-Mail-Adresse',
      securePasswordLabel: 'Passwort (mind. 8 Zeichen)',
      secureCta: 'E-Mail hinzufügen',
      secureGoogle: 'Mit Google sichern',
      secureSent: 'Bestätigungslink verschickt. Klick ihn an, dann ist dein Konto gesichert.',
      secureUnavailable: 'Konto sichern geht gerade nicht. Versuch es später noch einmal.',
      anonymousSignOutWarn: 'Dein Konto hat noch keine E-Mail. Wenn du dich abmeldest, kommst du nicht mehr an deinen Fortschritt. Trotzdem abmelden?',
      guestBadge: 'Gast',
      guestBadgeLabel: 'Konto ohne E-Mail, jetzt sichern',
      securePrompt: {
        first_lesson: { title: 'Erste Lektion geschafft', body: 'Dein Fortschritt liegt bisher nur in diesem Browser. Mit einer E-Mail bleibt er erhalten.' },
        first_drive: { title: 'Deine Fahrt ist gespeichert, aber nur hier', body: 'Fahrten und Fehlerprotokolle liegen bisher nur auf diesem Gerät. Mit einer E-Mail gehen sie nicht verloren.' },
        trial_ending: { title: 'Noch 2 Tage Pro-Testphase', body: 'Sichere dein Konto jetzt, dann bleibt alles erhalten, egal welchen Pass du später wählst.' },
        benefits: ['Fortschritt bleibt, auch wenn Browserdaten gelöscht werden', 'Auf Handy und Laptop mit demselben Konto'],
        later: 'Später',
        close: 'Schließen',
      },
    ...
    tracker: {
      ...
      mistakes: {
        ...
        schoolZoneSpeeding: '🏫 Schulzone: Zu schnell',
        pedestrianSafety: 'Fußgängerschutz missachtet',
        ...
        mirrorCheck: 'Spiegelblick vergessen',
    ...
    dashboard: {
      ...
      hotspots: 'Gefahren-Hotspots',
      hotspotsDesc: 'Bekannte Problemstellen in deiner Stadt',
      hotspotsNearby: 'Hotspots in der Nähe',
      hotspotsEmpty: 'Keine Hotspots verfügbar',
      hotspotsLoading: 'Lade Hotspots...',
      hotspotsCritical: 'Kritisch',
      hotspotsHigh: 'Hoch',
      hotspotsMedium: 'Mittel',
      hotspotsLow: 'Niedrig',
      hotspotsDrivers: 'Fahrer',
      hotspotsIncidents: 'Vorfälle',
      hotspotsPro: 'Pro',
    },
    licenseSelector: {
    ...
    curriculum: {
      ...
      cockpitTrainer: 'Cockpit-Trainer: Anfahren & Schalten',
      preDriveTrainer: 'Cockpit-Check: Bedienelemente & Warnleuchten',
      preDriveTrainerSub: 'Finde jedes Bedienelement und kenne jede Warnleuchte',
      cockpitTrainerSub: 'Kupplung, Gas und Schalten interaktiv üben',
    ...
    legal: {
      ...
      consent: {
        ...
        intro: 'Damit DriveDE Fahrten aufzeichnen und auswerten kann, verarbeiten wir während einer Fahrt deinen Standort und die Bewegungssensoren deines Handys.',
        gpsTitle: 'GPS und Sensoren',
        gpsDesc: 'Geschwindigkeit und Strecke werden nur während einer laufenden Fahrt erfasst.',
        telemetryTitle: 'Fahrtauswertung',
        telemetryDesc: 'Aus den Bewegungsdaten erkennt die App typische Fehler wie zu spätes Bremsen.',
        controlTitle: 'Volle Kontrolle',
        controlDesc: 'Unter Konto kannst du deine Daten jederzeit exportieren oder löschen.',
        agreePrefix: 'Ich bin mit der Verarbeitung meiner Daten wie oben beschrieben und in der ',
        agreeLink: 'Datenschutzerklärung',
        agreeSuffix: ' einverstanden.',
        accept: 'Zustimmen und weiter',
        footer: 'Verarbeitung nach DSGVO',
      },
      sections: {
    ...
    maneuvers: {
      ...
      interactive: {
        ...
        preDrive: {
          title: 'Cockpit-Check',
          phaseControls: 'Bedienelemente finden',
          phaseLamps: 'Warnleuchten-Quiz',
          promptLabel: 'Zeige:',
          lampQuestion: 'Was bedeutet diese Leuchte?',
          found: 'gefunden',
          wrongTap: 'Das war ein anderes Bedienelement. Schau auf die Position im Cockpit.',
          correct: 'Richtig!',
          wrong: 'Leider falsch.',
          next: 'Weiter',
          completed: 'Cockpit-Check bestanden!',
          scoreLabel: 'Quiz-Ergebnis',
          finish: 'Check abschließen',
          controls: {
            indicatorStalk: { name: 'Blinkerhebel', desc: 'Links am Lenkrad: hoch = rechts blinken, runter = links blinken. Ziehen = Lichthupe.' },
            wiperStalk: { name: 'Scheibenwischerhebel', desc: 'Rechts am Lenkrad: Intervall, normal, schnell. Nach vorn = Wischwasser.' },
            lightSwitch: { name: 'Lichtschalter', desc: 'Drehschalter links: Standlicht, Abblendlicht. In der Prüfung musst du ihn blind finden.' },
            fogRear: { name: 'Nebelschlussleuchte', desc: 'Am Lichtschalter: nur bei Sichtweite unter 50 m erlaubt, max. 50 km/h.' },
            hazard: { name: 'Warnblinkanlage', desc: 'Rotes Dreieck in der Mittelkonsole: bei Panne, Stauende und Abschleppen.' },
            horn: { name: 'Hupe', desc: 'Mitte des Lenkrads: nur bei Gefahr oder zum Überholen außerorts erlaubt.' },
            defrostRear: { name: 'Heckscheibenheizung', desc: 'Taste in der Mittelkonsole: beschlagene Heckscheibe frei machen, Sicht ist Pflicht.' },
            handbrake: { name: 'Handbremse', desc: 'Zwischen den Sitzen: beim Anfahren am Berg und beim Parken. Vor der Fahrt lösen!' },
          },
          lamps: {
            oil: { name: 'Öldruck', meaning: 'Öldruck zu niedrig: sofort anhalten und Motor abstellen.' },
            battery: { name: 'Batterie / Ladekontrolle', meaning: 'Batterie wird nicht geladen: Werkstatt aufsuchen.' },
            coolant: { name: 'Kühlmitteltemperatur', meaning: 'Motor zu heiß: anhalten, abkühlen lassen, Kühlmittel prüfen.' },
            brake: { name: 'Bremsanlage', meaning: 'Bremsproblem oder Handbremse angezogen: sofort prüfen.' },
            abs: { name: 'ABS', meaning: 'Antiblockiersystem gestört: Bremsen funktionieren, aber ohne ABS.' },
            airbag: { name: 'Airbag', meaning: 'Airbag-System gestört: Rückhaltesystem kann ausfallen.' },
            engine: { name: 'Motorkontrollleuchte', meaning: 'Motorsteuerung meldet einen Fehler: bald zur Werkstatt.' },
            fogRearLamp: { name: 'Nebelschlussleuchte aktiv', meaning: 'Nebelschlussleuchte ist eingeschaltet: nur unter 50 m Sicht erlaubt.' },
          },
        },
        cockpit: {
          title: 'Anfahren & Schalten',
          modeManual: 'Schaltgetriebe',
          modeAutomatic: 'Automatik',
          stepLabel: 'Schritt',
          readouts: { speed: 'KM/H', rpm: 'U/MIN', gear: 'GANG' },
          power: {
            engine: 'MOTOR',
            clutch: 'KUPPLUNG',
            gearbox: 'GETRIEBE',
            engaged: 'Kraftschluss',
            slipping: 'Schleifpunkt',
            none: 'Kein Kraftfluss',
            label: 'Kraft',
          },
          controls: {
            clutch: 'Kupplung',
            pedalTravel: 'Pedalweg',
            brake: 'BREMSE',
            gas: 'GAS',
            engineBtn: 'Motor',
            gearLabel: 'Gang wählen',
          },
          msgs: {
            stall: 'Motor abgewürgt! Kupplung zu schnell kommen lassen. Starte den Motor neu.',
            grind: 'Es kracht im Getriebe! Erst die Kupplung ganz durchtreten, dann schalten.',
            needClutchStart: 'Zum Starten: Kupplung ganz durchtreten und Bremse halten.',
            needBrakeStart: 'Zum Starten: Bremse gedrückt halten.',
            needBrakeShift: 'Zum Schalten aus P/N: Bremse gedrückt halten.',
          },
          steps: {
            manual: {
              start: { title: 'Motor starten', hint: 'Kupplung ganz durchtreten, Bremse halten, dann den Startknopf drücken.' },
              first: { title: '1. Gang einlegen', hint: 'Kupplung ganz unten lassen und im Schaltschema den 1. Gang wählen.' },
              moveOff: { title: 'Anfahren am Schleifpunkt', hint: 'Kupplung langsam bis ca. 50% kommen lassen und dabei sanft Gas geben. Zu schnell = abgewürgt!' },
              second: { title: 'In den 2. Gang schalten', hint: 'Beschleunige auf über 15 km/h, Kupplung durchtreten, 2. Gang, Kupplung wieder kommen lassen.' },
              stop: { title: 'Anhalten ohne Abwürgen', hint: 'Bremsen und kurz vor dem Stillstand die Kupplung ganz durchtreten.' },
              off: { title: 'Abstellen', hint: 'In den Leerlauf (N) schalten und den Motor ausschalten.' },
            },
            automatic: {
              start: { title: 'Motor starten', hint: 'Bremse gedrückt halten und den Startknopf drücken.' },
              drive: { title: 'Fahrstufe D wählen', hint: 'Mit gedrückter Bremse den Wählhebel auf D stellen.' },
              moveOff: { title: 'Anfahren', hint: 'Bremse lösen, das Auto kriecht an. Sanft Gas geben bis 10 km/h.' },
              stop: { title: 'Anhalten', hint: 'Vom Gas gehen und bremsen, bis das Auto steht. Bremse gedrückt halten.' },
    ...
    curriculumData: {
            lessons: {
              'basics-0': {
                title: 'Schnellstart Deutschland',
  ...
  en: {
    common: {
      ...
      publicTrainer: {
        ...
        savePrompt: 'Save your result and keep going?',
        saveHint: 'A free account keeps your progress and unlocks the other trainers.',
        saveCta: 'Continue for free',
        oneMore: 'One more round',
        close: 'Close',
        examQuestion: 'When is your practical exam?',
        examHint: 'This becomes your practice plan. You can change it later.',
        examNotBooked: 'Not booked yet',
        examContinue: 'Continue',
        daysLeft: (n: number) => n === 0 ? 'Your exam is today.' : n === 1 ? '1 day until your exam.' : `${n} days until your exam.`,
        examPast: 'That date has passed. Enter a new one when you have the next appointment.',
        planWithDate: (remaining: number, perWeek: number) => `${remaining} trainers still open. At ${perWeek} a week you finish before the date.`,
        planNoDate: (remaining: number) => `${remaining} trainers still open. Every exam retake costs about 600 euros, so knowing them first pays for itself.`,
        keepPrompt: 'Keep your plan and countdown?',
        keepHint: 'A free account shows the countdown every day and remembers what you already know.',
        keepCta: 'Keep my plan',
        planTitle: 'Your plan until the exam',
        shareCta: 'Share your result',
        moreTrainers: 'Parking and eight more trainers are in the app.',
        moreTrainersLink: 'See them',
        resultTitle: 'Your result',
        resultScore: (correct: number, total: number) => `${correct} of ${total} correct`,
        resultTime: (seconds: string) => `${seconds} seconds`,
        fasterThan: (pct: number) => `Faster than ${pct}% of learners here.`,
        flawless: 'No mistakes. Exactly what the examiner wants to see.',
        yourMistake: 'Your mistake, explained',
        examConsequence: 'In the exam this mistake ends the drive and costs about 600 euros.',
        moreMistakes: (n: number) => n === 1 ? 'One more intersection also had a wrong tap.' : `${n} more intersections also had a wrong tap.`,
        share: 'Share',
        shareHint: 'As an image for your driving school group.',
        shareDone: 'Image saved, text copied. Paste it into WhatsApp.',
        ladder: {
          title: 'Three exercises',
          step: (n: number) => `Exercise ${n}`,
          rung1: 'Right before left',
          rung2: 'Roundabout',
          rung3: 'Parking',
          now: 'Up now',
          open: 'Open',
          done: 'Done',
          opensAfter: 'After exercise 1',
          locked: 'With a free account',
          nextRung: 'Next: roundabout',
          roundaboutDone: 'Roundabout done. Two of three exercises finished.',
          unlockPrompt: 'Unlock parking?',
          unlockHint: 'The third exercise, parking with reference points, and eight more trainers come with a free account.',
          unlockCta: 'Unlock for free',
      ...
      proOnlyFeature: 'Available for Pro users only',
      cancel: 'Cancel',
      save: 'Save',
      pause: 'Pause',
      replay: 'Replay',
    ...
    welcome: {
      hero: {
        ...
        titlePrefix: 'Pass the German driving test',
        titleHighlight: 'first time.',
        subtitle: 'Free 3D trainers for priority rules, parking and roundabouts, for learners and licence converters.',
    ...
    account: {
      ...
      publicReportToggle: 'Report Visibility',
      publicReportToggleDesc: 'Allow your instructor to access your progress via the shared link.',
      openingGoogle: 'Opening Google …',
      continueWithGoogle: 'Continue with Google',
      signInEmail: 'Sign in with email',
      continueGuest: 'Continue as guest',
      guestNote: 'Google and email are optional. You can also use the app entirely in guest mode.',
      anonymousTitle: 'Account not secured',
      anonymousDesc: 'You are using DriveDE without an email. Your progress lives only in this browser. Add an email to get back in on your phone or after switching browsers.',
      secureTitle: 'Secure your account',
      secureEmailLabel: 'Email address',
      securePasswordLabel: 'Password (min. 8 characters)',
      secureCta: 'Add email',
      secureGoogle: 'Secure with Google',
      secureSent: 'Confirmation link sent. Click it and your account is secured.',
      secureUnavailable: 'Securing the account is not possible right now. Please try again later.',
      anonymousSignOutWarn: 'Your account has no email yet. If you sign out, you will not get back to your progress. Sign out anyway?',
      guestBadge: 'Guest',
      guestBadgeLabel: 'Account without email, secure it now',
      securePrompt: {
        first_lesson: { title: 'First lesson done', body: 'So far your progress lives only in this browser. Add an email to keep it.' },
        first_drive: { title: 'Your drive is saved, but only here', body: 'Drives and mistake logs are stored on this device only. Add an email so they are not lost.' },
        trial_ending: { title: '2 days of Pro trial left', body: 'Secure your account now and everything is kept, whichever pass you choose later.' },
        benefits: ['Progress is kept even if browser data is cleared', 'One account on your phone and your laptop'],
        later: 'Later',
        close: 'Close',
      },
    ...
    tracker: {
      ...
      mistakes: {
        ...
        schoolZoneSpeeding: '🏫 School Zone: Speeding',
        pedestrianSafety: 'Pedestrian Safety Violation',
        other: 'Other Mistake',
        ...
        mirrorCheck: 'Missed Mirror Check',
    ...
    dashboard: {
      ...
      hotspots: 'Danger Hotspots',
      hotspotsDesc: 'Known problem areas in your city',
      hotspotsNearby: 'Nearby Hotspots',
      hotspotsEmpty: 'No hotspots available',
      hotspotsLoading: 'Loading hotspots...',
      hotspotsCritical: 'Critical',
      hotspotsHigh: 'High',
      hotspotsMedium: 'Medium',
      hotspotsLow: 'Low',
      hotspotsDrivers: 'drivers',
      hotspotsIncidents: 'incidents',
      hotspotsPro: 'Pro',
    },
    licenseSelector: {
    ...
    curriculum: {
      ...
      cockpitTrainer: 'Cockpit Trainer: Moving Off & Shifting',
      preDriveTrainer: 'Cockpit Check: Controls & Warning Lamps',
      preDriveTrainerSub: 'Find every control and know every warning lamp',
      cockpitTrainerSub: 'Practice clutch, gas and shifting interactively',
    ...
    legal: {
      ...
      consent: {
        ...
        intro: 'To record and analyse your drives, DriveDE processes your location and your phone\'s motion sensors while a drive is running.',
        gpsTitle: 'GPS and sensors',
        gpsDesc: 'Speed and route are captured only during an active drive.',
        telemetryTitle: 'Drive analysis',
        telemetryDesc: 'The app uses the motion data to spot typical mistakes such as braking late.',
        controlTitle: 'Full control',
        controlDesc: 'You can export or delete your data at any time under Account.',
        agreePrefix: 'I agree to the processing of my data as described above and in the ',
        agreeLink: 'Privacy Policy',
        agreeSuffix: '.',
        accept: 'Agree and continue',
        footer: 'GDPR compliant processing',
      },
      sections: {
    ...
    maneuvers: {
      ...
      interactive: {
        ...
        preDrive: {
          title: 'Cockpit Check',
          phaseControls: 'Find the controls',
          phaseLamps: 'Warning lamp quiz',
          promptLabel: 'Show me:',
          lampQuestion: 'What does this lamp mean?',
          found: 'found',
          wrongTap: 'That was a different control. Check its position in the cockpit.',
          correct: 'Correct!',
          wrong: 'Not quite.',
          next: 'Next',
          completed: 'Cockpit check passed!',
          scoreLabel: 'Quiz score',
          finish: 'Finish check',
          controls: {
            indicatorStalk: { name: 'Indicator stalk', desc: 'Left of the wheel: up = right turn, down = left turn. Pull = headlight flash.' },
            wiperStalk: { name: 'Wiper stalk', desc: 'Right of the wheel: intermittent, normal, fast. Push forward = washer fluid.' },
            lightSwitch: { name: 'Light switch', desc: 'Rotary switch on the left: parking light, low beam. In the exam you must find it blind.' },
            fogRear: { name: 'Rear fog light', desc: 'On the light switch: only allowed below 50 m visibility, max 50 km/h.' },
            hazard: { name: 'Hazard lights', desc: 'Red triangle in the centre console: breakdowns, end of traffic jams, towing.' },
            horn: { name: 'Horn', desc: 'Centre of the wheel: only for danger, or overtaking outside built-up areas.' },
            defrostRear: { name: 'Rear window defroster', desc: 'Button in the centre console: clear a fogged rear window, visibility is mandatory.' },
            handbrake: { name: 'Handbrake', desc: 'Between the seats: hill starts and parking. Release before driving!' },
          },
          lamps: {
            oil: { name: 'Oil pressure', meaning: 'Oil pressure too low: stop immediately and switch the engine off.' },
            battery: { name: 'Battery / charging', meaning: 'Battery is not charging: visit a workshop.' },
            coolant: { name: 'Coolant temperature', meaning: 'Engine too hot: stop, let it cool, check coolant.' },
            brake: { name: 'Brake system', meaning: 'Brake problem or handbrake engaged: check immediately.' },
            abs: { name: 'ABS', meaning: 'Anti-lock braking system fault: brakes work, but without ABS.' },
            airbag: { name: 'Airbag', meaning: 'Airbag system fault: the restraint system may fail.' },
            engine: { name: 'Check engine', meaning: 'Engine management reports a fault: see a workshop soon.' },
            fogRearLamp: { name: 'Rear fog light on', meaning: 'Rear fog light is switched on: only allowed below 50 m visibility.' },
          },
        },
        cockpit: {
          title: 'Moving Off & Shifting',
          modeManual: 'Manual',
          modeAutomatic: 'Automatic',
          stepLabel: 'Step',
          readouts: { speed: 'KM/H', rpm: 'RPM', gear: 'GEAR' },
          power: {
            engine: 'ENGINE',
            clutch: 'CLUTCH',
            gearbox: 'GEARBOX',
            engaged: 'Engaged',
            slipping: 'Biting point',
            none: 'No power flow',
            label: 'Power',
          },
          controls: {
            clutch: 'Clutch',
            pedalTravel: 'Pedal travel',
            brake: 'BRAKE',
            gas: 'ACCELERATOR',
            engineBtn: 'Engine',
            gearLabel: 'Select gear',
          },
          msgs: {
            stall: 'Engine stalled! You released the clutch too fast. Restart the engine.',
            grind: 'Gearbox grinding! Press the clutch fully before shifting.',
            needClutchStart: 'To start: press the clutch fully and hold the brake.',
            needBrakeStart: 'To start: hold the brake.',
            needBrakeShift: 'To shift out of P/N: hold the brake.',
          },
          steps: {
            manual: {
              start: { title: 'Start the engine', hint: 'Press the clutch fully, hold the brake, then press the start button.' },
              first: { title: 'Select 1st gear', hint: 'Keep the clutch fully pressed and pick 1st gear in the shift pattern.' },
              moveOff: { title: 'Move off at the biting point', hint: 'Release the clutch slowly to about 50% while gently adding gas. Too fast = stall!' },
              second: { title: 'Shift to 2nd gear', hint: 'Accelerate past 15 km/h, clutch fully down, select 2nd, release the clutch again.' },
              stop: { title: 'Stop without stalling', hint: 'Brake, and press the clutch fully just before standstill.' },
              off: { title: 'Shut down', hint: 'Shift to neutral (N) and switch the engine off.' },
            },
            automatic: {
              start: { title: 'Start the engine', hint: 'Hold the brake and press the start button.' },
              drive: { title: 'Select D', hint: 'With the brake held, move the selector to D.' },
              moveOff: { title: 'Move off', hint: 'Release the brake, the car creeps forward. Gently add gas to 10 km/h.' },
              stop: { title: 'Come to a stop', hint: 'Off the gas and brake until the car stands still. Keep the brake held.' },
              park: { title: 'Park & shut down', hint: 'Selector to P and switch the engine off.' },
            },
          },
          keysHintManual: 'Keyboard: B = hold brake · Space = gas · Arrow up/down = clutch · 1-6, N, R = gear · E = engine',
          keysHintAutomatic: 'Keyboard: B = hold brake · Space = gas · P, R, N, D = gear · E = engine',
          completed: 'Exercise complete!',
          scoreLabel: 'Smoothness',
