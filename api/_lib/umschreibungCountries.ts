...
export const UMSCHREIBUNG_COUNTRIES: UmschreibungCountry[] = [
  ...
  // Added to Anlage 11 FeV by the amendment in force since 18 Aug 2026 (BGBl. 2026 I Nr. 236).
  { code: 'ME', nameEn: 'Montenegro',      nameDe: 'Montenegro',       flag: '🇲🇪', tier: 'annex11',
    noteEn: 'On Anlage 11 since 18 August 2026: no theory or practical test.',
    noteDe: 'Seit 18. August 2026 auf der Anlage 11: keine Theorie- und keine praktische Prüfung.' },
  ...
  // Added to Anlage 11 FeV by the amendment in force since 18 Aug 2026 (BGBl. 2026 I Nr. 236).
  { code: 'UA', nameEn: 'Ukraine',         nameDe: 'Ukraine',          flag: '🇺🇦', tier: 'annex11',
    noteEn: 'On Anlage 11 since 18 August 2026: no theory or practical test for classes A1, A, B, BE, C1, C1E, C, CE, D1, D1E, D, DE. Truck and bus classes still need the medical and eyesight certificates (Anlage 5 and 6).',
    noteDe: 'Seit 18. August 2026 auf der Anlage 11: keine Theorie- und keine praktische Prüfung für A1, A, B, BE, C1, C1E, C, CE, D1, D1E, D, DE. Für Lkw- und Busklassen weiterhin ärztliches Gutachten und Sehtest (Anlage 5 und 6).' },
